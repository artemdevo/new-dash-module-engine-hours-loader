...
const float engineRunTime = 1800.7; //THIS IS THE VALUE THAT WILL BE CHANGED. THIS REFLECTS THE TOTAL ENGINE RUNTIME. ONLY LIST TENTHS OF AN HOUR DUE TO FLOAT LIMIT
